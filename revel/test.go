...
For example, to run the booking sample application's tests:
    ...
    revel test github.com/Gazillion-Platform-Team/revel/samples/booking dev
...
func testApp(args []string) {
	...
	for _, module := range revel.Modules {
		if module.ImportPath == "github.com/Gazillion-Platform-Team/revel/modules/testrunner" {
...
You can add it to a run mode configuration with the following line:
	...
	module.testrunner = github.com/Gazillion-Platform-Team/revel/modules/testrunner
